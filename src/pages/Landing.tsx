      ...
      <nav className="fixed top-0 z-50 w-full bg-background border-b border-border px-6">
        <div className="mx-auto flex h-[56px] max-w-[1200px] items-center justify-between">
          <Link to="/" className="flex items-center gap-2 -ml-0.5">
            <StackedLogo size={16} />
            <span className="text-[14px] font-bold text-foreground tracking-[0.08em] uppercase">ASM Lab</span>
          </Link>
          ...
          <div className="pt-[52px] pb-16 relative flex">
            ...
            <div className="relative z-[3] flex-1 min-w-0 max-w-[540px]">
              <h1 className="text-[clamp(2rem,4vw,3.2rem)] font-[500] leading-[1.08] tracking-[-0.04em] text-foreground max-w-[540px]">
                Found a bug in ASM Lab? Tell us.
              </h1>
              <p className="mt-6 text-base leading-relaxed text-muted-foreground max-w-[420px]">
                Report what went wrong in under a minute — no account, no sign-in. We capture what you were doing right before it broke, so we can reproduce it and fix it fast.
              </p>
              <div className="mt-10 flex items-center gap-4">
                ...
                <Link to="/track">
                  <button className="text-[14px] px-6 py-3 border border-foreground/40 text-foreground hover:bg-foreground hover:text-background transition-colors">
                    Track my reports
                  </button>
                </Link>
              </div>
      ...
      <section className="relative z-10 pt-24 pb-24 px-6 overflow-hidden">
        <div className="mx-auto max-w-[1200px] relative">
          ...
          <h2 className="text-[clamp(1.8rem,3vw,2.5rem)] font-[500] tracking-[-0.03em] text-foreground max-w-[500px] leading-[1.15]">
            Describe it once.<br />We take it from there.
          </h2>
              ...
              {[
                {
                  ...
                  desc: "A short title, what you expected, and what actually happened. Add a screenshot if it helps. That's the whole form.",
                  graphic: "bars",
                },
                {
                  title: "Your last steps come along",
                  desc: "Your last few actions and your browser details are attached automatically, so we can retrace exactly what you did.",
                  graphic: "flow",
                },
                {
                  title: "Follow it to solved",
                  desc: "Every report gets a tracking number. Check back any time to see whether it's still in progress or already solved.",
                  graphic: "chart",
                },
              ].map((feature, i) => (
                <div
        ...
        <div className="mx-auto max-w-[1200px] relative">
          <div className="border border-border bg-background p-10 max-w-[720px] mx-auto">
            <blockquote className="text-[20px] font-[400] leading-[1.5] tracking-[-0.01em] text-foreground/85">
              "I reported a glitch on a Tuesday afternoon, it was fixed by Thursday. I could see exactly where my report stood the whole time."
            </blockquote>
            <div className="mt-6 flex items-center gap-3">
              ...
              <div>
                ...
                <span className="text-[13px] text-muted-foreground ml-2">ASM Lab user</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="relative z-10 pt-32 pb-40 px-6 overflow-hidden">
        <div className="mx-auto max-w-[1200px] text-center relative">
          ...
          <p className="mt-5 text-[15px] text-muted-foreground max-w-[400px] mx-auto">
            It takes a minute, and every report goes straight to the people fixing ASM Lab.
          </p>
      ...
      <div className="relative z-10 border-t border-border">
        <div className="mx-auto max-w-[1200px] px-6 py-6 flex items-center justify-between">
          <div className="flex items-center gap-2 -ml-0.5">
            <StackedLogo size={16} />
            <span className="text-[12px] font-bold text-foreground uppercase tracking-[0.08em]">ASM Lab</span>
          </div>
